...
\end{equation}
For prior distributions all $n_i$ are assumed to be uniformly distributed and the variance is assumed to be a Jeffrey's distribution as we do not have any useful information about it (REF tsunami)(REF Bayes book).
